<template>
  <div class="daily-management">
    <BasicPageTopBottom :marginGap="1">
      <template #top>
        <el-card shadow="never" body-class="daily-management-search">
          <BasicTableSearch
            labelWidth="84"
      ...
      <template #content>
        <el-card shadow="never" body-class="daily-managemen-table" class="basic-table-card">
          <div class="height-100 basic-result">
            ...
            <el-table v-loading="queryLoading" :data="queryDataList" height="100%">
              ...
              <el-table-column label="日期" prop="dateStr" width="120" />
              <el-table-column label="日报内容" prop="content" min-width="450">
                <template #default="scope">
              ...
              <el-table-column fixed="right" label="操作" width="160">
                <template #default="scope">
                  <el-button link type="primary" @click="handleDailyDetail(scope.row)">
                    详情
                  </el-button>
                </template>
              </el-table-column>
    ...
    <daily-drawer ref="dailyDrawerRef" />
  </div>
</template>
...
import { requestPageDaily } from '@/api/report/dailyManagement'
